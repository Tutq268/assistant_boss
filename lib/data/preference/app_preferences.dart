...
import 'package:hanam/foundation/constant/share_preference_connstant.dart';
...
class AppPreferences with LogMixin {
  ...
  Future<bool> saveCurrentUser(AccountModel preferenceUserData) {
    ...
    Future<bool> saveKeyboardHeight(double keyboardHeight) {
    return _sharedPreference.setDouble(
        SharedPreferenceKeys.keyboardHeight, keyboardHeight);
  }
  double get getKeyboardHeight {
    final height =
        _sharedPreference.getDouble(SharedPreferenceKeys.keyboardHeight) ?? 0;
    return height;
  }
  bool get isLoggedIn {
    final token =
