...
class _AvoidBottomInsetState extends State<AvoidBottomInset>
  ...
  void dispose() async {
    ...
    final savedHeight = getIt.get<AppPreferences>().getKeyboardHeight;
    if (keyboardHeight != savedHeight) {
      // await .instance.setDouble('keyboardHeight', keyboardHeight);
      getIt.get<AppPreferences>().saveKeyboardHeight(keyboardHeight);
    }
  }
